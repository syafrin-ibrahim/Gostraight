  ...
  return (
    <View style={styles.container}>
      <View style={styles.view1}>
        <Icon type='material' name='arrow-back' size={32} color={colors.grey1}/>
      </View>
      <View style={styles.view2}>
        <TouchableOpacity>
            <View style={styles.view3}>
                <Avatar avatarStyle={{}} rounded size={30} source={require('../../assets/blankProfilePic.jpg')} />
                <Text style={{ marginLeft : 5}}>For Some One</Text>
                <Icon type='material' name='expand-more' color={colors.grey1}size={26} />
            </View>
        </TouchableOpacity>
          ...
          <View>
              <TouchableOpacity onPress={()=> navigation.navigate('destinationscreen')}>
                <View style={styles.view6}>
                    <Text style={styles.text1}>From Any Where ?</Text>
                </View>
              </TouchableOpacity>
              <View style={styles.view7}>
                ...
                <Icon type='material' name='add' color={colors.black}size={25} />
                </View>
              </View>
          </View>
        </View>
